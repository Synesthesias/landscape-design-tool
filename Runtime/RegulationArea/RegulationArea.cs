...
namespace Landscape2.Runtime
{
        public class RegulationArea : MonoBehaviour
    {
        ...
        public static RegulationArea Create(Transform parentTrans)
        {
            ...
            // go.name = GetNumberWithTag("RegulationArea", "規制エリア");
        ...
        public void GenMesh()
        {
            ...
            Material material = MaterialUtil.MakeMaterial(AreaColor);
        ...
        private static string GetNumberWithTag(string tagname, string title)
        {
            int rval = -1;
