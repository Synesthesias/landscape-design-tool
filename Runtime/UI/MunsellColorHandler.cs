...
public class MunsellColorHandler : MonoBehaviour
{
    ...
    public void SelectColor(int n)
    {
        ...
        if (targetObject)
        {
            ...
            if (!hasColor)
            {
                ...
                Material[] newMat = new Material[materials.Length + 1];
                i = 0;
                ...
                newMat[i] = mat;
                targetObject.GetComponent<Renderer>().sharedMaterials = newMat;
            }
    ...
    public void CancelColor()
    {
        ...
        targetObject.GetComponent<Renderer>().sharedMaterials = _oldMat;
    }
